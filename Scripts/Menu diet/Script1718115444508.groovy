...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Menu Diet'))

WebUI.click(findTestObject('Object Repository/Page_Menu diet/html_Menu diet                            k_1cd572'))
