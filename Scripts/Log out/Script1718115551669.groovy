...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_SignOut'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/html_Dashboard             katalonfont-fami_daaab6'))
