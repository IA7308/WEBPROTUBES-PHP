...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login HealthSis/input_Login_password'), 'EpplGP+PMAWe/rZM8+54/A==')

WebUI.click(findTestObject('Object Repository/Page_Login HealthSis/input_Login_signInbtn'))

WebUI.click(findTestObject('Object Repository/Page_Login HealthSis/div_Email atau password salah'))
