...
WebUI.setText(findTestObject('Object Repository/Page_SignUp HealthSis/input_Register_LastName'), 'Ardana')

WebUI.setText(findTestObject('Object Repository/Page_SignUp HealthSis/input_Register_Username'), 'herdiardn')

WebUI.setText(findTestObject('Object Repository/Page_SignUp HealthSis/input_Register_Email'), 'herdiardan@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_SignUp HealthSis/input_Register_password'), 'iGDxf8hSRT4=')

WebUI.click(findTestObject('Object Repository/Page_SignUp HealthSis/input_Register_btn btn-primary'))

WebUI.click(findTestObject('Object Repository/Page_Login HealthSis/div_Login_gambar'))
